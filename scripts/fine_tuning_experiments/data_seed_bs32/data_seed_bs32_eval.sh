...
#SBATCH -o %j_timit_fine_tune_data_seed_bs32_eval.out
#SBATCH --mail-type END


# Evaluation results for our the models that change the data seed only 

EVAL_RESULTS_CSV=data/evaluation_results/aggregate_metrics/timit_fine_tune_data_seed_bs32_eval.csv
...
multipa-evaluate --local_models \
  $MODEL_DIR/fine_tune_hyperparam_tuning_6/wav2vec2-large-lv60_phoneme-timit_english_timit-4k-buckeye-ipa \
