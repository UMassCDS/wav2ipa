...
|-- model_evaluation_espeak_only.ipynb      # Notebook to get evaluation results for models that require Espeak (needs special installation environment): facebook/wav2vec2-lv-60-espeak-cv-ft, facebook/wav2vec2-xlsr-53-espeak-cv-ft
...
- `facebook/wav2vec2-lv-60-espeak-cv-ft` and `facebook/wav2vec2-xlsr-53-espeak-cv-ft`